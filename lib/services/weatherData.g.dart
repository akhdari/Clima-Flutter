...
WeatherData _$WeatherDataFromJson(Map<String, dynamic> json) => WeatherData(
      coord: Coor.fromJson(json['coord'] as Map<String, dynamic>),
...
Coor _$CoorFromJson(Map<String, dynamic> json) => Coor(
      lat: (json['lat'] as num).toDouble(),
      lon: (json['lon'] as num).toDouble(),
    );

Map<String, dynamic> _$CoorToJson(Coor instance) => <String, dynamic>{
      'lat': instance.lat,
      'lon': instance.lon,
    };
